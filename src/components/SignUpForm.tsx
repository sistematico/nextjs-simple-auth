    ...
    <form onSubmit={onSubmit} className="space-y-8" autoComplete="nope">
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          className={`p-3 mt-0.5 w-full rounded border-gray-300 shadow-sm sm:text-sm dark:border-gray-600 dark:bg-gray-900 dark:text-white ${errors.name ? "border-red-500" : ""}`}
        />
        {errors.name && (
